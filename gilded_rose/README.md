...
[here](http://iamnotmyself.com/2011/02/13/refactor-this-the-gilded-rose-kata/) and adapted by [Jim Weirich](https://github.com/jimweirich).

This is a refactorying kata, so you will be starting with a legacy
code base. Read the description below for the "rules"
involving this kata.
...
* The original had no tests.  Since this is a refactoring kata, we feel
...
* The original used a hard coded set of "items", presumably for
  testing the code.  Since a test suite is now present, the hard coded values
  are not of much use. The interface has been changed to accept a list of
